		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapuidemowalkthroughorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuidemowalkthroughorders-display": {
								"semanticObject": "sapuidemowalkthroughorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.demo.walkthrough.orders",
									"url": sap.ui.require.toUrl("sap/ui/demo/walkthrough/orders")
								}
							}
						}
					}
